    ...
    <section id="monitoramento" ref={sectionRef} className="py-28 bg-brand-bg">
      <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <a
            href="#comecar"
            className="inline-flex items-center justify-center bg-primary text-white font-semibold rounded-full px-7 py-[15px] text-[1.0625rem] shadow-green hover:bg-primary-hover hover:-translate-y-0.5 transition-all duration-200"
          >
