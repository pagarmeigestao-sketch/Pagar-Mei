...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="flex items-center gap-2.5 bg-white rounded-2xl px-4 py-3 relative"
            style={{ boxShadow: '0 8px 32px rgba(0,0,0,0.15), 0 2px 8px rgba(0,0,0,0.08)' }}
          >
            <span className="text-[0.875rem] font-semibold text-gray-800 whitespace-nowrap">
              Consultar meu CNPJ agora?
            </span>
            <button
            ...
            {/* Arrow down */}
            <div
              className="absolute -bottom-1.5 right-7 w-3 h-3 bg-white rotate-45"
      ...
      <motion.a
        href="https://wa.me/5511996740623?text=Oi%20Pagar%20MEI%2C%20quero%20verificar%20meu%20CNPJ"
        target="_blank"
